...
const WebAgent = ({ webAgentUrl }: WebAgentProps) => {
  return (
    <div className="relative bg-cardGreen w-full h-full group dark:bg-darkBg">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 left-24 md:left-32 transform -rotate-[30deg] w-full rounded-2xl">
        <Image
          alt="Web Agent"
          className="md:h-[500px] object-cover w-full rounded-2xl"
          src={webAgentUrl}
        />
      </div>
